        ...
        <div className="location-grid">
          <div>
            ...
            <div style={{ marginBottom: '2rem' }}>
              ...
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.2rem', color: '#1a2640', lineHeight: 1.5 }}>
                123 Placeholder Street<br />Schenectady, NY 12305
              </div>
            </div>
          ...
          {/* Map placeholder — swap src for a Google Maps embed of your address */}
          <div style={{ position: 'relative', minHeight: 360, background: '#1a2640', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(92,61,30,0.2)' }}>
            <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.1rem', fontStyle: 'italic', color: 'rgba(245,237,216,0.6)', textAlign: 'center', padding: '2rem' }}>
              Map embed goes here.<br />Replace with a Google Maps iframe for your address.
            </p>
          </div>
        </div>
      </section>
